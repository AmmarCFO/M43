            ...
            <div className="divide-y divide-[#F5EFE7] text-xs sm:text-sm">
              ...
              <div className="p-3.5 flex flex-col sm:flex-row justify-between bg-white gap-2">
                <div className="text-[#3d3d3d]">
                  <p className="font-semibold">{isArabic ? "صافي الإيرادات" : "Net Revenue"}</p>
                ...
                <span className="font-mono font-bold text-[#1d1d1f] self-start sm:self-center">SAR {netRevenue.toLocaleString()}</span>
              </div>

              {/* Total Mathwa's Share (That it took) */}
              <div className="p-3.5 flex justify-between bg-[#FAF8F5]/30">
                <span className="text-[#3d3d3d] font-semibold">{isArabic ? "حصة مثوى الفعلية المستلمة (7% من صافي الإيراد)" : "Total Mathwa's Share Received (7%)"}</span>
